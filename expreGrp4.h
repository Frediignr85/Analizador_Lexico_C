...
char * comprobar(char expresion[]){
    ...
    if(parte4 >0){
        printf("\nHay mas de 2 '$' seguidos en la expresion regular\n");
        error=1;
    }
    if(parte1 > 0){
    ...
    if(parte2 == 0){
        ...
        printf("\nHay mas de 1 '/p1' en la expresion regular\n");
        error++;
    }
    else if(parte2 == 1){
        int parte21 = comprobarCaracteresRepetido(expre, ")/pf$$");
        if(parte21 == 0){
            ...
            if(parte22 == 0){
                printf("\nExiste un /pi pero no existe un /pf en la expresion regular\n");
                error++;
            }
            else if(parte22 == 1){
                char *separador = "/pf*";
                ...
                printf("\nExiste un '/pi' y hay mas de un /pf en la expresion regular\n");
                error++;
            }   
        }
        else if(parte21 == 1){
            ...
            printf("\nExiste mas de un '/pi' en la expresion regular\n");
            error++;
        }   
    }
    if(parte3 == 0){
        ...
        if(parte31 == 0){
            ...
            if(parte32 > 0){
                printf("\nExiste /ff y no existe un /fi en la expresion regular\n");
                error++;
            }
            char *separador = "*";
            char * str3 =(char *) malloc(1 +  strlen(separador));
            ...
            int parte32 = comprobarCaracteresRepetido(expre,")/ff*");
            if(parte32 == 0){
                printf("\nExiste un /fi pero no existe un /ff en la expresion regular\n");
                error++;
            }
            else if(parte32 == 1){
                char *separador = ")/ff*";
                ...
                printf("\nExiste mas de un '/fi' en la expresion regular\n");
                error++;
            }
        }
        else{
        ...
        if(parte31 == 0){
            ...
            printf("\nExiste mas de un '/ff' en la expresion regular\n");
            error++;
        }
    }
    if(error > 0){
